...
public class Jenkins
{
	...
	public static final String	PATH_HOME	= Constants.PATH_DRIVERS_LOCAL + COMPANY + Constants.DELIMETER_PATH;
	...
	public static void copyFileLog(String filePathDestination) throws Throwable
	{
		...
		if (JavaHelpers.hasValue(jenkinsBuildNumber))
		{
			...
			String jenkinsWorkspace = JavaHelpers.readPropertyOrEnv("WORKSPACE") + Constants.DELIMETER_PATH;
			// C:\Jenkins\jobs\Vivit\builds\999\log
			String filePathNameSource = jenkinsWorkspace + "builds" + Constants.DELIMETER_PATH + jenkinsBuildNumber
					+ Constants.DELIMETER_PATH + "log";
			// C:\Workspace\Data\Vivit\Data\20190101\Jenkins_999.log
			String filePathNameDestination = filePathDestination + COMPANY + "_" + jenkinsBuildNumber + IExtension.LOG;
