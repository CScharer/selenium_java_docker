...
public class SauceUtils
{
	...
	private static void addBuildNumberToUpdate(Map<String, Object> updates)
	{
		for (Entry entry : getBuildNumerKeyValues().entrySet())
		{
			...
			Environment.sysOut("Key:[" + key + "], Value:[" + value + "], buildNumber:[" + buildNumber + "]");
	...
	public static DesiredCapabilities setDesiredCapabilitiesAutoIT(DesiredCapabilities desiredCapabilities,
			String executable, boolean background)
	{
	...
	public static DesiredCapabilities setDesiredCapabilitiesDefaults(DesiredCapabilities desiredCapabilities)
	{
