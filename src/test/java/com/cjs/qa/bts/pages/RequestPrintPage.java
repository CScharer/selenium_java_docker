...
public class RequestPrintPage extends Page
{
	...
	private final By		CheckboxPullPrint						= By
			.id(NODE_REQUEST_PRINT + "printPolicyId:pullPrint");
	private final By		CheckboxPrintWorkSheets					= By
			.id(NODE_REQUEST_PRINT + "printPolicyId:printWorksheet");
	private final By		DropdownPrinter							= By
			.id(NODE_REQUEST_PRINT + "printPolicyId:printer");
	private final By		CheckboxSPLPrint						= By
			.id(NODE_REQUEST_PRINT + "printPolicyId:splPrint");
	...
	private final By		buttonMinimizeTransactionInformation	= By
			.id(NODE_REQUEST_PRINT + "heading3form1:requestPrint:heading3");
	private final By		buttonMinimizePrintOptions				= By
			.id(NODE_REQUEST_PRINT + "printPolicyId:printheading");
