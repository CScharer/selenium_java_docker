...
public class FormsPage extends Page
{
	...
	private final By		buttonQuickScroll		= By
			.xpath(NODE_Forms1 + "forms:variableDataBtnGroup']/div[6]/input");
	...
	public void clickFormsBox(String value)
	{
		...
		final By formToClick = By.xpath(formsListBoxBegin + form + Constants.QUOTE_SINGLE + ")][contains(.,"
				+ Constants.QUOTE_SINGLE + edition + formsListBoxEnd);
