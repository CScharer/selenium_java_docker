...
public class RatePage extends Page
{
	...
	private final By		toggleResults				= By
			.xpath(NODE_PROCESSEDERRS + "cplProcessedErrorsTable']/div[1]/span[1]/button");
	private final By		labelPolicyTotal			= By.xpath(NODE_PROCESSEDERRS + "overviewTotM']");
	private final By		labelCommercialAuto			= By
			.xpath(NODE_PROCESSEDERRS + "productsTableEx1:0:overviewTotM1']");
	private final By		labelAgriculturalOutput		= By
			.xpath(NODE_PROCESSEDERRS + "productsTableEx1:1:overviewTotM1']");
	private final By		labelGeneralLiability		= By
			.xpath(NODE_PROCESSEDERRS + "productsTableEx1:2:overviewTotM1']");
	private final By		labelPolicywideCoverages	= By
			.xpath(NODE_PROCESSEDERRS + "productsTableEx1:3:overviewTotM1']");
	private final By		buttonRateNow				= By
			.xpath(".//*[@id='form1:cplProcessedResults:flashScreenRateButton']");
