...
public class RateLeftNavPage extends Page
{
	...
	private final String	NODE_PROCESSEDERRS	= ".//*[@id='form1:viewNavigationMenu:navigationMenuLevel1:";
	private final By		linkManageProducts	= By
			.xpath(NODE_PROCESSEDERRS + "5:navigationMenuItem:menuLinkSubmittable']/span");
