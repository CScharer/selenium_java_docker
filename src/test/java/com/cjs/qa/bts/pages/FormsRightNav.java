...
public class FormsRightNav extends Page
{
	...
	private final By		linkRequestPrint			= By
			.xpath(".//*[@id='" + NODE_FORM1ADMIN + "0" + NODE_NAVIGATIONMENU + "menuLinkSubmittable']");
	...
	private final By		linkRate					= By.xpath(
			".//*[@id='" + NODE_FORM1ADMIN + "policyIssuanceFunctions:2:navigationMenuItem:menuCommandSubmittable']");
