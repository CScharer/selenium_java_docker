...
public class _BTSCrosswordChallengePage extends Page
{
	...
	private final String				sScreenShot		= "C:" + Constants.DELIMETER_PATH + "Temp"
			+ Constants.DELIMETER_PATH + "Crossword" + Constants.DELIMETER_PATH + sYear + "_" + sMonth + ".png";
	...
	{
		final String sURL = "http://crossword.info/btsclientservices/" + sMonth + "_" + sYear + "/";// final
																									// String
																									// sURL
																									// =
	...
	public void getGridSquares()
	{
		...
		{
			final WebElement oDiv = webDriver.findElement(By.xpath(".//*[@id='game']//div[" + iGridSquare + "]"));
		...
		final String sKeySet = mapGridSquares.keySet().toString().replace("[", "").replace("]", "").replace(" ", "");
	...
	public void solvePuzzle(String sLetter)
	{
		for (final String sGridSquare : lGridSquares)
		{
			...
			((JavascriptExecutor) webDriver).executeScript("arguments[0].innerText = '" + sLetter + "'", oSpan);
		}
		clickbuttonCheck();
		for (final String sGridSquare : lGridSquares)
		{
			...
			{
				if (isElementPresent(By.xpath(".//*[@id='game']//div[" + iGridSquare + "][not(*/div[.='X'])]")))
				{
					mapGridSquares.put(iGridSquare, sLetter);
				}
			}
	...
	public void solvePuzzle()
	{
		for (final String sGridSquare : lGridSquares)
		{
			...
			((JavascriptExecutor) webDriver)
					.executeScript("arguments[0].innerText = '" + mapGridSquares.get(iGridSquare) + "'", oSpan);
		}
		clickbuttonCheck();
