...
public class LoginPage extends Page
{
	...
	public String openGenesys(String company, String environment) throws SQLException, ClassNotFoundException
	{
		String sURL = null;
		...
		{
			Environment.sysOut("company [" + company + "], environment[" + environment + "] not configured.");
		}
		return sURL;
	}
