...
public class OffersAndActivityPage extends Page
{
	...
	final By		buttonGetYoursByMail		= By.xpath(
			".//div[@class='image-cta-link']//div[@class='inner-content']/button/i[contains(@class,'btn-ctaIcon')]/../..");
	final By		buttonCOUPONS				= By
			.xpath(".//li[contains(@class,'menu-list-desk')]/a[@data-dtmtext='COUPONS']");
	...
	final By		labelThanks					= By
			.xpath(".//div[@class='coupon-heading']/h6[.='THANK YOU FOR YOUR REQUEST.']");
	final By		labelCouponInTheMail		= By
			.xpath(".//div[@class='coupon-heading']/h6[.='LOOKS LIKE YOUR MONTHLY COUPON IS ALREADY IN THE MAIL.']");
