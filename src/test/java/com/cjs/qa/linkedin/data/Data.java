...
public class Data
{
	...
	public static StringBuilder appendRecordContactInfo(StringBuilder sqlStringBuilder, String linkedInURL,
			String fieldName, String fieldValue) throws Throwable
	{
	...
	public static StringBuilder appendRecordContactInfoUpdated(StringBuilder sqlStringBuilder, String linkedInURL,
			String fieldName, String fieldValue) throws Throwable
	{
		Environment.sysOut("***ClassMethodDebug***:[" + JavaHelpers.getCurrentClassMethodDebugName() + "]");
		StringBuilder stringBuilder = new StringBuilder();
		...
		stringBuilder.append(
				"[Last Updated]='" + DateHelpers.getCurrentDateTime(DateHelpers.FORMAT_US_STANDARD_DATE) + "' ");
		stringBuilder.append("WHERE [" + Data.FIELD_LINKEDIN_URL + "]='" + linkedInURL + "';");
		sqlStringBuilder.append(stringBuilder);
		if (Data.getQueryRecordCount(sqlStringBuilder) == Data.RECORD_UPDATE_MIN)
		{
	...
	public static StringBuilder appendRecordURL(StringBuilder sqlStringBuilder, Map<String, String> map)
			throws Throwable
	{
		Environment.sysOut("***ClassMethodDebug***:[" + JavaHelpers.getCurrentClassMethodDebugName() + "]");
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("UPDATE [" + Data.TABLE_LINKEDIN + "] ");
		stringBuilder.append("SET [" + Data.FIELD_LINKEDIN_URL + "]='"
				+ map.get(Data.FIELD_LINKEDIN_URL).replaceAll("'", "''") + "' ");
		stringBuilder.append("WHERE [First Name]='" + map.get("First Name").replaceAll("'", "''") + "' ");
		...
		stringBuilder.append("AND [Connected On]='" + map.get("Connected On").replaceAll("'", "''") + "';");
		sqlStringBuilder.append(stringBuilder);
		if (Data.getQueryRecordCount(sqlStringBuilder) == Data.RECORD_UPDATE_MIN)
		{
			sqlStringBuilder = updateRecords(sqlStringBuilder);
	...
	public static String getQueryLinkedInURL()
	{
		...
		List<String> monthList = Arrays
				.asList("Jan;Feb;Mar;Apr;May;Jun;Jul;Aug;Sep;Oct;Nov;Dec".split(Constants.DELIMETER_LIST));
	...
	public static String getQueryUpdateLinkedInURL()
	{
		...
		stringBuilder.append("SET [" + FIELD_LINKEDIN_URL + "]=REPLACE(REPLACE([" + FIELD_LINKEDIN_URL + "],'"
	...
	public static StringBuilder updateRecords(StringBuilder sqlStringBuilder) throws Throwable
	{
		...
		if (!sqlStringBuilder.toString().equals(""))
		{
			...
			String message = Constants.NEWLINE + sqlStringBuilder.toString().replaceAll(";", Constants.NEWLINE);
			...
			Email.sendEmail(CJSConstants.EMAIL_ADDRESS_GMAIL, EPasswords.EMAIL_GMAIL.getValue(),
					CJSConstants.EMAIL_ADDRESS_GMAIL, "", "", "LinkedIn Records Affected (" + recordsAffected + ")",
					message, "");
