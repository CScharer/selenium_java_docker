...
/**
 * Mobile Testing Configuration for Selenium and Appium.
 * Provides utilities for mobile browser emulation and native app testing.
 */
public final class MobileTestsConfiguration {
   ...
   */
  public static AndroidDriver createAndroidDriver(String appiumUrl, MobileDevice device,
   ...
   * @throws MalformedURLException if Appium URL is invalid
   */
  public static AppiumDriver createAppiumDriver(String appiumUrl,
      MutableCapabilities capabilities) throws MalformedURLException {
