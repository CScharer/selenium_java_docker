...
public class NegativeTests {
    ...
    public void testNonExistentElement() {
        ...
        try {
            ...
            WebElement nonExistent = driver.findElement(
                By.id("this-element-definitely-does-not-exist-12345"));
        ...
        Assert.assertTrue(elementNotFound, 
            "NoSuchElementException should be thrown for non-existent element");
    ...
    public void testElementWaitTimeout() {
        ...
        Assert.assertTrue(timeoutOccurred,
            "TimeoutException should occur when element doesn't appear");
    ...
    public void testErrorRecovery() {
        ...
        Assert.assertTrue(currentUrl.contains("google.com"),
            "Should successfully recover and navigate");
