...
public class ConvertTestSet
{
	...
	{
		final List<List<String>> listList = Arrays.asList(Arrays.asList("One", "1"), Arrays.asList("Two", "2"),
				Arrays.asList("Three", ""), Arrays.asList("Four", "4"), Arrays.asList("Five", "5"),
				Arrays.asList("Six", "6"), Arrays.asList("Seven", ""), Arrays.asList("Eight", "8"),
				Arrays.asList("Nine", "9"), Arrays.asList("Ten", "10"));
		return listList;
	}
	...
	public void fromNumberToLetter()
	{
		...
		{
			Environment.sysOut("number:[" + number + "], letter:[" + Convert.fromNumberToLetter(number) + "]");
		}
	}
	...
	public void fromNumberToLetterExcel()
	{
		...
		{
			Environment.sysOut("number:[" + JavaHelpers.formatNumber(number, FORMAT_NUMBER) + "], letter:["
