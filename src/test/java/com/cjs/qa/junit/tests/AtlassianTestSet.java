...
public class AtlassianTestSet
{
	...
	public void addTestCucumberScenario()
	{
		...
		final TestCucumberScenario testCucumberScenario = new TestCucumberScenario(project,
				"Summary:TestCucumberScenario", "Description:TestCucumberScenario", "Test", "Cucumber", "Scenario",
				"Given I Do Something\\nThen I Did Something");
		Environment.sysOut("testCucumberScenario:" + testCucumberScenario.toString());
		Environment.sysOut("testCucumberScenario:" + JSON.formatPretty(testCucumberScenario.toString(), 4));
	}
	...
	{
		final Project project = new Project("QSDT");
		final TestGeneric testGeneric = new TestGeneric(project, "Summary:TestGeneric", "Description:TestGeneric",
				"Test", "Generic", "TestGeneric.sh");
	...
	public void addTestManual()
	{
		...
		{
			final ManualTestSteps manualTestSteps = new ManualTestSteps(indexStep, "Step " + indexStep,
					"Data " + indexStep, "Result " + indexStep);
			manualTestStepsList.add(manualTestSteps);
		}
		final TestManual testManual = new TestManual(project, "Summary:TestManual", "Description:TestManual", "Test",
				"Manual", manualTestStepsList);
