...
public class Environment
{
	...
	public static final String			EMAIL_SIGNATURE			= FSO
			.fileReadAll(Constants.PATH_OUTLOOK_SIGNATURES + "MSN" + IExtension.HTM);
	public static boolean				environmentSet			= false;
	public static final String			FILE_CONFIG				= Constants.PATH_ROOT + "Configurations"
			+ Constants.DELIMETER_PATH + "Environments" + IExtension.XML;
	public static String				FOLDER_DATA				= Constants.PATH_FILES_DATA + COMPANY
	...
	{
		sysOut("Environment Variable " + Constants.QUOTE_DOUBLE + "SCROLL_TO_OBJECTS" + Constants.QUOTE_DOUBLE + "["
				+ scrollToObjects + "]");
	...
	public static void setEnvironmentFileStructure(String project)
	{
		...
		switch (project)
		{
			...
			case "wellmark":
				...
				break;
			default:
				Assert.fail("The setEnvironmentFileStructure has not been defined for the [" + project + "] Project");
				break;
		}
	}
	...
	private static String getStackInfo()
	{
		...
		for (final StackTraceElement stackTraceElement : stackTraceElements)
		{
			...
			{
				stack = stackTraceElement.getFileName() + Constants.DELIMETER_LIST + stackTraceElement.getMethodName()
						+ Constants.DELIMETER_LIST + "Line (" + stackTraceElement.getLineNumber() + ")";
				break;
			}
		}
		return stack;
	...
	{
		return DateHelpers.getCurrentDateAndTime() + Constants.DELIMETER_LIST + Constants.CURRENT_USER
				+ Constants.DELIMETER_LIST + getComputerName() + Constants.DELIMETER_LIST;
	}
	...
	private static void setOverrideUser(String node, String config)
	{
		try
		{
			...
			stringBuilder.append(node + ":[" + overrideUser + "], Computer/Host Name:[" + config + "], UserID:["
