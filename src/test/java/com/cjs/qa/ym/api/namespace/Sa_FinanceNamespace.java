...
public class Sa_FinanceNamespace extends YMService
{
	public Map<String, String> batchCreate(String commerceType, String closingDate, boolean closedOnly) throws Throwable
	{
		switch (commerceType)
		{
			case "D":
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Finance_Batch_Create"
				+ IExtension.HTM);
		...
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Finance.Batch.Create" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<CommerceType>" + commerceType + "</CommerceType>");
	...
	public Map<String, String> batchesGet(String timestamp, String startBatchID) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Finance_Batches_Get"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Finance.Batches.Get" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Timestamp>" + timestamp + "</Timestamp>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<StartBatchID>" + startBatchID + "</StartBatchID>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}

	public Map<String, String> invoicePaymentCreate(String invoiceNo, String amount, String type, String refNo,
			String paymentDate, String payerName, String payerEmail, String billOrganization, boolean updateInvoiceInfo,
			boolean autoCloseInvoice, boolean useInvoiceAddress, String billAddress1, String billAddress2,
			String billCity, String billLocation, String billPostalCode, String billCountry, String billPhone,
			String paymentNotes, String internalNotes) throws Throwable
	{
		// Applies a payment to an invoice.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Finance_Invoice_Payment_Create" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Finance.Invoice.Payment.Create" + Constants.QUOTE_DOUBLE + ">");
		...
		stringBuilder.append(Constants.nlTab(1, 2) + "<BillOrganization>" + billOrganization + "</BillOrganization>");
		stringBuilder
				.append(Constants.nlTab(1, 2) + "<UpdateInvoiceInfo>" + updateInvoiceInfo + "</UpdateInvoiceInfo>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<AutoCloseInvoice>" + autoCloseInvoice + "</AutoCloseInvoice>");
		stringBuilder
				.append(Constants.nlTab(1, 2) + "<UseInvoiceAddress>" + useInvoiceAddress + "</UseInvoiceAddress>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<BillAddress1>" + billAddress1 + "</BillAddress1>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<BillAddress2>" + billAddress2 + "</BillAddress2>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<BillCity>" + billCity + "</BillCity>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<BillLocation>" + billLocation + "</BillLocation>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<BillPostalCode>" + billPostalCode + "</BillPostalCode>");
		...
		stringBuilder.append(Constants.nlTab(1, 2) + "<PaymentNotes>" + paymentNotes + "</PaymentNotes>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<InternalNotes>" + internalNotes + "</InternalNotes>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}
}