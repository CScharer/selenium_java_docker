...
public class Sa_MembersNamespace extends YMService
{
	public Map<String, String> allGetIDs(String timestamp, int websiteID, String groups) throws Throwable
	{
		...
		// <ServerGmtBias>.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Members_All_GetIDs"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.All.GetIDs" + Constants.QUOTE_DOUBLE + ">");
	...
	public Map<String, String> allMemberTypesGet() throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Members_All_MemberTypes_Get" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.All.MemberTypes.Get" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}
	...
	public Map<String, String> allRecentActivity() throws Throwable
	{
		...
		// Latest photo
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Members_All_RecentActivity" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.All.RecentActivity" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}

	public Map<String, String> certificationsJournalEntryCreate(String iD, String cEUsEarned, String cEUsExpireDate,
			String certificationID, String certificationName, String description, String entryDate, String scorePercent,
			String creditTypeCode) throws Throwable
	{
		// Create a CEU Journal Entry.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Members_Certifications_JournalEntry_Create" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.Certifications.JournalEntry.Create" + Constants.QUOTE_DOUBLE + ">");
		...
		stringBuilder.append(Constants.nlTab(1, 2) + "<CEUsExpireDate>" + cEUsExpireDate + "</CEUsExpireDate>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<CertificationID>" + certificationID + "</CertificationID>");
		stringBuilder
				.append(Constants.nlTab(1, 2) + "<CertificationName>" + certificationName + "</CertificationName>");
		...
		stringBuilder.append(Constants.nlTab(1, 2) + "<ScorePercent>" + scorePercent + "</ScorePercent>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<CreditTypeCode>" + creditTypeCode + "</CreditTypeCode>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}

	public Map<String, String> commerceStoreGetOrderIDs(String iD, String timestamp, String status) throws Throwable
	{
		switch ("")
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Members_Commerce_Store_GetOrderIDs" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.Commerce.Store.GetOrderIDs" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ID>" + iD + "</ID>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Timestamp>" + timestamp + "</Timestamp>");
	...
	public Map<String, String> eventsEventRegistrationGet(String eventID, String iD) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Members_Events_Event_Registration_Get" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.Events.Event.Registration.Get" + Constants.QUOTE_DOUBLE + ">");
	...
	public Map<String, String> groupsAdd(String iD, String groupCode, boolean addAsMember, boolean isPrimaryGroup,
			boolean addAsGroupAdmin, String addGroupRepTitle) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Members_Groups_Add"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.Groups.Add" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ID>" + iD + "</ID>");
		...
		stringBuilder.append(Constants.nlTab(1, 2) + "<IsPrimaryGroup>" + isPrimaryGroup + "</IsPrimaryGroup>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<AddAsGroupAdmin>" + addAsGroupAdmin + "</AddAsGroupAdmin>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<AddGroupRepTitle>" + addGroupRepTitle + "</AddGroupRepTitle>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}

	public Map<String, String> groupsRemove(String iD, String groupCode, boolean removeAsMember,
			boolean removeAsGroupAdmin, String removeGroupRepTitle) throws Throwable
	{
		...
		// specified.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Members_Groups_Remove"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.Groups.Remove" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ID>" + iD + "</ID>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<GroupCode>" + groupCode + "</GroupCode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<RemoveAsMember>" + removeAsMember + "</RemoveAsMember>");
		stringBuilder
				.append(Constants.nlTab(1, 2) + "<RemoveAsGroupAdmin>" + removeAsGroupAdmin + "</RemoveAsGroupAdmin>");
		stringBuilder.append(
				Constants.nlTab(1, 2) + "<RemoveGroupRepTitle>" + removeGroupRepTitle + "</RemoveGroupRepTitle>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}
	...
	public Map<String, String> profileCreate(boolean useMemberTypeSetting) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Members_Profile_Create" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.Profile.Create" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(
				Constants.nlTab(1, 2) + "<UseMemberTypeSetting>" + useMemberTypeSetting + "</UseMemberTypeSetting>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}
	...
	public Map<String, String> referralsGet(String iD, String timestamp) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Members_Referrals_Get"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.Referrals.Get" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ID>" + iD + "</ID>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Timestamp>" + timestamp + "</Timestamp>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	...
	public Map<String, String> subAccountsGet(String iD, String timestamp) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Members_SubAccounts_Get" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Members.SubAccounts.Get" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ID>" + iD + "</ID>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Timestamp>" + timestamp + "</Timestamp>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
