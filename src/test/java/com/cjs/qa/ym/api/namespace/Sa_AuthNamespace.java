...
public class Sa_AuthNamespace extends YMService
{
	public Map<String, String> authenticate(String username, String password, String passwordHash) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Auth_Authenticate"
				+ IExtension.HTM);
		...
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Auth.Authenticate" + Constants.QUOTE_DOUBLE + ">");
		...
		stringBuilder.append(Constants.nlTab(1, 2) + "<PasswordHash>" + passwordHash + "</PasswordHash>");
