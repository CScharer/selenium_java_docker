...
public class Sa_PeopleNamespace extends YMService
{
	public Map<String, String> allGetIDs(String timestamp, int websiteID, String groups) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_People_All_GetIDs"
				+ IExtension.HTM);
		...
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.People.All.GetIDs" + Constants.QUOTE_DOUBLE + ">");
	...
	public Map<String, String> profileFindID(String importID, String constituentID, int websiteID, String username,
			String email) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_People_Profile_FindID"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.People.Profile.FindID" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ImportID>" + importID + "</ImportID>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ConstituentID>" + constituentID + "</ConstituentID>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<WebsiteID>" + websiteID + "</WebsiteID>");
	...
	public Map<String, String> profileGet(String id) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_People_Profile_Get"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.People.Profile.Get" + Constants.QUOTE_DOUBLE + ">");
	...
	public Map<String, String> profileGroupsGet(String iD) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_People_Profile_Groups_Get" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.People.Profile.Groups.Get" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ID>" + iD + "</ID>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}
	...
	public Map<String, String> profileUpdate(String iD, String xml) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_People_Profile_Update"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.People.Profile.Update" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ID>" + iD + "</ID>");
	...
	public boolean updateMemberData(StringBuilder apiGUIDSQL, String xml) throws Throwable
	{
		...
		for (final String apiGUID : arrayMembers)
		{
			...
			try
			{
				final int errCode = Integer.parseInt(XML.getNode(sXML, "YourMembership_Response", "ErrCode"));
				switch (errCode)
				{
					case 0:
						success = true;
