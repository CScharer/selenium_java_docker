...
{
	public Map<String, String> allSearch(String searchText, String pageSize, String startRecord) throws Throwable
	{
		// Returns paged results for a search request. Returns a maximum of 100
		// records per request.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "People_All_Search"
				+ IExtension.HTM);
		...
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "People.All.Search" + Constants.QUOTE_DOUBLE + ">");
	...
	public Map<String, String> profileGet(String iD) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "People_Profile_Get"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "People.Profile.Get" + Constants.QUOTE_DOUBLE + ">");
