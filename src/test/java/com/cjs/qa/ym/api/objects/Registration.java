...
public class Registration
{
	...
	public Registration(String status, String eventName, String firstName, String lastName, String badgeNumber,
			String registrationID, String dateRegister, String attended, String orderID, String memberID,
			String invoiceID, String isPrimaryRegistrant, String primaryRegistrantRegistrationID,
			String primaryRegistrantMemberID, String attendeeType)
	{
		this.status = status;
