...
public class Sa_MemberNamespace extends YMService
{
	public Map<String, String> certificationsGet(String iD, boolean isArchived) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Member_Certifications_Get" + IExtension.HTM);
		...
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Member.Certifications.Get" + Constants.QUOTE_DOUBLE + ">");
	...
	public Map<String, String> certificationsJournalGet(String iD, boolean showExpired, String startDate,
			String entryID, String certificationID, int pageSize, int pageNumber) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Member_Certifications_Journal_Get" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Member.Certifications.Journal.Get" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<ID>" + iD + "</ID>");
