...
public class Sa_ExportNamespace extends YMService
{
	public Map<String, String> allInvoiceItems(boolean unicode, String date) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Export_All_InvoiceItems" + IExtension.HTM);
		...
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.All.InvoiceItems" + Constants.QUOTE_DOUBLE + ">");
	...
	public Map<String, String> careerOpenings(boolean unicode, String date) throws Throwable
	{
		...
		// returned by Sa.Export.Status as <ExportURI>.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Export_Career_Openings" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Career.Openings" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Date>" + date + "</Date>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	...
	public Map<String, String> donationsInvoiceItems(boolean unicode, String date) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Export_Donations_InvoiceItems" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Donations.InvoiceItems" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Date>" + date + "</Date>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	...
	public Map<String, String> donationsTransactions(boolean unicode, String date) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Export_Donations_Transactions" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Donations.Transactions" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Date>" + date + "</Date>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	...
	public Map<String, String> duesInvoiceItems(boolean unicode, String date) throws Throwable
	{
		...
		// returned by Sa.Export.Status as <ExportURI>.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Export_Dues_InvoiceItems" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Dues.InvoiceItems" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Date>" + date + "</Date>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	...
	public Map<String, String> duesTransactions(boolean unicode, String date) throws Throwable
	{
		...
		// returned by Sa.Export.Status as <ExportURI>.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Export_Dues_Transactions" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Dues.Transactions" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Date>" + date + "</Date>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	...
	public Map<String, String> eventRegistrations(boolean unicode, String eventID, String sessionIDs, String productID,
			String processed, String lastName, boolean attendedEvent) throws Throwable
	{
		switch (processed)
		...
		// export file will be returned by Sa.Export.Status as <ExportURI>.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Export_Event_Registrations" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Event.Registrations" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		...
		stringBuilder.append(Constants.nlTab(1, 2) + "<AttendedEvent>" + attendedEvent + "</AttendedEvent>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	}
	...
	public Map<String, String> financeBatch(boolean unicode, String batchID) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Export_Finance_Batch"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Finance.Batch" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
	...
	public Map<String, String> exportDataMembers(String dateTimeFrom) throws Throwable
	{
		...
		do
		{
			...
			Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + "-statusCheckCount:[" + statusCheckCount
					+ "], exportStatus:[" + exportStatus + "]");
		} while (exportStatus.equals(ExportStatus.WORKING) || exportStatus.equals(ExportStatus.UNKNOWN));
	...
	public Map<String, String> members(boolean unicode, boolean customFields, String timestamp) throws Throwable
	{
		...
		// code. Upon receiving a COMPLETE status code, the download location of
		// your export file will be returned by Sa.Export.Status as <ExportURI>.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Export_Members"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Members" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<CustomFields>" + customFields + "</CustomFields>");
	...
	public Map<String, String> membersGroups(boolean unicode, String timestamp) throws Throwable
	{
		...
		// code. Upon receiving a COMPLETE status code, the download location of
		// your export file will be returned by Sa.Export.Status as <ExportURI>.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Export_Members_Groups"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Members.Groups" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Timestamp>" + timestamp + "</Timestamp>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	...
	public Map<String, String> status(String exportID) throws Throwable
	{
		...
		Environment.sysOut(
				JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Export_Status" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Status" + Constants.QUOTE_DOUBLE + ">");
	...
	public Map<String, String> storeInvoiceItems(boolean unicode, String date) throws Throwable
	{
		...
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC
				+ "Sa_Export_Store_InvoiceItems" + IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Store.InvoiceItems" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Date>" + date + "</Date>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
	...
	public Map<String, String> storeOrders(boolean unicode, String date) throws Throwable
	{
		...
		// code, the download location of your export file will be returned by
		// Sa.Export.Status as <ExportURI>.
		Environment.sysOut(JavaHelpers.getCurrentClassMethodName() + " - " + URL_YM_API_DOC + "Sa_Export_Store_Orders"
				+ IExtension.HTM);
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(SessionNamespace.getSessionID() + SessionNamespace.getSAPasscode());
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_PREFIX + Constants.QUOTE_DOUBLE
				+ "Sa.Export.Store.Orders" + Constants.QUOTE_DOUBLE + ">");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Unicode>" + unicode + "</Unicode>");
		stringBuilder.append(Constants.nlTab(1, 2) + "<Date>" + date + "</Date>");
		stringBuilder.append(Constants.nlTab(1, 1) + YMAPI.LABEL_CALL_METHOD_SUFFIX);
		return getAPIXMLResponse("POST", stringBuilder.toString());
