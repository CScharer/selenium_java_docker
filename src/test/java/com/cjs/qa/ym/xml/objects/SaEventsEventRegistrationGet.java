...
public class SaEventsEventRegistrationGet
{
    ...
    public String toString()
    {
        ...
        stringBuilder.append(
                "Primary Registrant Registration ID:" + getPrimaryRegistrantRegistrationID() + Constants.NEWLINE);
        stringBuilder.append("Primary Registrant Member ID:" + getPrimaryRegistrantMemberID() + Constants.NEWLINE);
        stringBuilder.append("Attendee Type:" + getAttendeeType() + Constants.NEWLINE);
        stringBuilder.append("Data Set:" + Constants.NEWLINE + getDataSet().toString() + Constants.NEWLINE);
