...
public class _Marshall
{
    ...
    public void testEventsAllSearch() throws JAXBException
    {
        ...
        YourMembership_Response yourMembership_Response = yourMembership_ResponseUnmarshall(filePathName);
        ...
        for (int eventsIndex = 0; eventsIndex < yourMembership_Response.getEventsAllSearch().getResults().getItem()
                .size(); eventsIndex++)
        {
            Item item = yourMembership_Response.getEventsAllSearch().getResults().getItem().get(eventsIndex);
    ...
    {
        String filePathName = "C:\\Workspace\\Data\\Vivit\\Data\\Events\\Registration\\49170B25-A49F-46F7-98CB-3DA7042D4BB1.xml";
        YourMembership_Response yourMembership_Response = yourMembership_ResponseUnmarshall(filePathName);
        ...
        System.out.println("Getting the Phone Number:" + yourMembership_Response.getSaEventsEventRegistrationGet().getDataSet().getPhone().getValue());
    }

    public YourMembership_Response yourMembership_ResponseUnmarshall(String filePathName) throws JAXBException
    {
        ...
        YourMembership_Response yourMembership_Response = (YourMembership_Response) unmarshaller.unmarshal(file);
        return yourMembership_Response;
    }

    public String yourMembership_ResponseMarshall(YourMembership_Response yourMembership_Response,String filePathName) throws JAXBException
    {
        JAXBContext jaxbContext = JAXBContext.newInstance(YourMembership_Response.class);
