...
public class Groups
{
	...
	public static String		EXTENDED_LIST	= "GroupDirectoryURL;CalendarURL;BlogsURL;ForumsURL;PhotoGalleryURL";

	public Groups()
	{
	}

	public Groups(String groupType, String pageID, String groupName, String elapsedTime, String wallPosts,
			String chapterURL)
	{
	...
	public static void intializeGroupsList(List<Groups> groupsList) throws Throwable
	{
		...
		sqlStringBuilder.append(JDBCConstants.SELECT_ALL_FROM + "[" + VivitTables.VIVIT_GROUPS_CURRENT + "] ");
		sqlStringBuilder.append(JDBCConstants.ORDER_BY + "[" + "Name" + "];");
		List<Map<String, String>> groupListMap = jdbc.queryResultsString(sqlStringBuilder.toString(), false);
		jdbc.close();
		...
		{
			throw new QAException(JavaHelpers.getCurrentMethodName() + ":No records were found in the ["
					+ VivitTables.VIVIT_GROUPS_CURRENT + "] table.");
		}
	}
