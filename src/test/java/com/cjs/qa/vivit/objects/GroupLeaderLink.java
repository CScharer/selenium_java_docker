...
public class GroupLeaderLink
{
	...
	public GroupLeaderLink(String groupType, String pageID, String webSiteMemberID, String leaderType)
	{
	...
	private static String appendRecord(String tableName, List<String> fieldsList, GroupLeaderLink record)
	{
	...
	public static void setGroupLeaderLinkWebSiteMemberIDList(List<String> groupLeaderLinkWebSiteMemberIDList)
	{
