...
public class MyMemberProfilePage extends Page
{
	...
	// DECLARATIONS
	private final By			editEmail					= By.name("txt_email");
	private final By			editEmailConfirm			= By.name("txt_emailConfirm");
	private final By			editGender					= By.name("txt_gender");
	private final By			editTitle					= By.name("txt_title");
	private final By			editFirstName				= By.name("txt_firstName");
	private final By			editMiddleName				= By.name("txt_middleName");
	private final By			editLastName				= By.name("txt_lastName");
	private final By			editSuffixName				= By.name("txt_suffix");
	private final By			editNickname				= By.name("txt_nickName");
	private final By			editMaidenName				= By.name("txt_maidenName");
	private final By			editBirthday				= By.name("dat_birthday");
	private final By			editPersonalURL				= By.name("txt_personalURL");
	private final By			editPhoneHomeFaxAreaCode	= By.name("txt_homeFaxAreaCode");
	private final By			editPhoneHomeFax			= By.name("txt_homeFax");
	private final By			editEmailAlternate			= By.name("txt_emailAlternate");
	private final By			editAlternateIMUsername		= By.name("txt_alternateIMUsername");
	private final By			editAlternateIMType			= By.name("txt_alternateIMType");
	private final By			editEmployeeName			= By.name("txt_employName");
	private final By			editEmployeeOwn				= By.name("bln_employOwn");
	private final By			editEmployeeTitle			= By.name("txt_employTitle");
	private final By			editEmployeeURL				= By.name("txt_employURL");
	private final By			editEmployeeAddress1		= By.name("txt_employAddress1");
	private final By			editEmployeeAddress2		= By.name("txt_employAddress2");
	private final By			editEmployeeCity			= By.name("txt_employCity");
	private final By			editEmployeeCountry			= By.name("txt_employCountry");
	private final By			editEmployeeState			= By.name("txt_employState");
	private final By			editEmployeeZip				= By.name("txt_employZip");
	private final By			editEmployeePhoneAreaCode	= By.name("txt_employPhoneAreaCode");
	private final By			editEmployeePhone			= By.name("txt_employPhone");
	private final By			editEmployeeFaxAreaCode		= By.name("txt_employFaxAreaCode");
	private final By			editEmployeeFax				= By.name("txt_employFax");
	private final By			editEmployeeContinent		= By.name("cdlCustomFieldValueIDcontinent");
	private final By			editUsedHPYears				= By.name("cdlCustomFieldValueIDUsedHPYears");
