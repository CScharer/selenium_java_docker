...
public class BoDPage extends Page
{
	...
	public static final String	URL			= "https://www.vivit-worldwide.org/general/custom.asp?page=2018board";
	...
	{
		final By labelName = By.xpath(".//*[@id='CustomPageBody']/h3/a[text()[contains(.,'" + value + "')]]");
		return getLabel(labelName);
	}

	public String getLabelTitle(String value)
	{
		final By labelTitle = By.xpath(".//*[@id='CustomPageBody']/p[text()[contains(.,'" + value + "')]]");
		return getLabel(labelTitle);
	}

	public String getLabelEmail(String value)
	{
		final By labelEmail = By.xpath(".//*[@id='CustomPageBody']/p/a[text()[contains(.,'" + value + "')]]");
		return getLabel(labelEmail);
	}

	public String getLabelCompany(String value)
	{
		final By labelCompany = By.xpath(".//*[@id='CustomPageBody']/p[text()[contains(.,'" + value + "')]]");
		return getLabel(labelCompany);
	}

	public String getLabelAddress(String value)
	{
		final By labelAddress = By.xpath(".//*[@id='CustomPageBody']/p[text()[contains(.,'" + value + "')]]");
		return getLabel(labelAddress);
	}

	public String getLabelCountry(String value)
	{
		final By labelCountry = By.xpath(".//*[@id='CustomPageBody']/p[text()[contains(.,'" + value + "')]]");
		return getLabel(labelCountry);
	}

	public String getLabelDuties(String value)
	{
		final By labelDuties = By.xpath(".//*[@id='CustomPageBody']/p/span[text()[contains(.,'" + value + "')]]");
