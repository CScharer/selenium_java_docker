...
{
	final By	byLogo				= By.xpath(".//*[@id='logo']/img");
	final By	CheckboxRememberMe	= By.xpath(".//*[@id='rememberme']");
	final By	buttonSignIn		= By.xpath(".//*[@id='ctl00_PageContent_MainLogin']//input[@value='Sign In']");
	final By	buttonSignOut		= By.xpath(".//*[@id='itoolbar']/a[.='Sign Out']");
	final By	editEmail			= By.xpath(".//*[@id='u']");
	final By	editPassword		= By.xpath(".//*[@id='p']");
	final By	linkSignIn			= By.xpath(".//*[@id='itoolbar']/a[.='Sign In']");
	...
	public List<String> getLanguagesSupported()
	{
		...
		By byLanguages = By
				.xpath(".//*[@id=':1.menuBody']/table/tbody/tr/td/a/div//span[2][not(contains(.,'Select Language'))]");
	...
	public String getLogoSource() throws QAException
	{
		...
		do
		{
			...
			{
				Environment
						.sysOut(QAException.ERROR + JavaHelpers.getCurrentClassMethodName() + ":Error Finding Logo.");
	...
	public void signIn(String eMail, String password, String RememberMe) throws QAException
	{
		...
		do
		{
			...
			{
				Environment.sysOut(QAException.ERROR + JavaHelpers.getCurrentClassMethodName() + ":Error Signing In.");
				if (attempt > ATTEMPTS_MAX)
				{
