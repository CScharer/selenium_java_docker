...
public class StaffPage extends Page
{
	...
	public void getData() throws QAException
	{
		...
		final List<WebElement> webElementList = getWebDriver()
				.findElements(By.xpath(".//*[@id='SpContent_Container']/table/tbody/tr/td/b/a[contains(@href,'id=')]"));
		...
		for (final StaffDetails staffDetails : staffDetailsList)
		{
			...
			WebElement webElement = getWebDriver().findElement(By.xpath(".//*[@id='SpContent_Container']"));
