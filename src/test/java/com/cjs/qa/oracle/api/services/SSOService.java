...
{
	private final String	baseAPISSO	= "https://SSOAPI." + OracleConstants.API_BASE + ".net/"
			+ Environment.getEnvironment() + "/" + OracleConstants.API_SSO_VERSION_MAJOR + "/"
	...
	public Map<String, String> authenticate(String eMail)
	{
		...
		final String apiRequest = "{Email: " + Constants.QUOTE_DOUBLE + eMail + Constants.QUOTE_DOUBLE + "," + "Password: "
				+ Constants.QUOTE_DOUBLE + "Password1!" + Constants.QUOTE_DOUBLE + "}";
		...
		try
		{
			map.put("ssoUserTokenId", new JSONObject(json).getJSONObject("body").getString("ssoUserTokenId"));
	...
	public String confirmUser(String eMail)
	{
		final Map<String, String> map = new HashMap<>();
		map.put("API_Method", JavaHelpers.getCurrentMethodName().toString());
		final String apiRequest = "{Email: " + Constants.QUOTE_DOUBLE + eMail + Constants.QUOTE_DOUBLE + "}";
	...
	public String createEmailExpirationToken(String eMail)
	{
		...
		final String apiRequest = "{ETID: " + Constants.QUOTE_DOUBLE + eMail + Constants.QUOTE_DOUBLE + "," + "Token: "
				+ Constants.QUOTE_DOUBLE + emailToken + Constants.QUOTE_DOUBLE + "}";
	...
	public void resetPassword(String eMail)
	{
		...
		final Map<String, String> map = new HashMap<>();
		map.put("API_Method", JavaHelpers.getCurrentMethodName().toString());
		final String apiRequest = "{EmailToken: " + Constants.QUOTE_DOUBLE + emailToken + Constants.QUOTE_DOUBLE + "," + "ETID: "
				+ Constants.QUOTE_DOUBLE + eMail + Constants.QUOTE_DOUBLE + "," + "NewPassword: " + Constants.QUOTE_DOUBLE
				+ CJSConstants.PASSWORD + Constants.QUOTE_DOUBLE + "}";
	 ...
	 * @return
	 */
	public Map<String, String> createAccount(String ssoUserTokenId, String partyID, String applicationAbbreviation,
			String userName)
	{
		final Map<String, String> map = new HashMap<>();
		map.put("API_Method", JavaHelpers.getCurrentMethodName().toString());
		final String apiRequest = "{" + Constants.QUOTE_DOUBLE + "ApplicationAbbreviation" + Constants.QUOTE_DOUBLE + ": "
				+ Constants.QUOTE_DOUBLE + applicationAbbreviation + Constants.QUOTE_DOUBLE + "," + Constants.QUOTE_DOUBLE + "Password"
				+ Constants.QUOTE_DOUBLE + ": " + Constants.QUOTE_DOUBLE + CJSConstants.PASSWORD + Constants.QUOTE_DOUBLE + ", "
				+ Constants.QUOTE_DOUBLE + "Username" + Constants.QUOTE_DOUBLE + ": " + Constants.QUOTE_DOUBLE + userName + Constants.QUOTE_DOUBLE
				+ ",},";
	...
	public Map<String, String> deleteSecurityQuestions(String ssoUserTokenId, String eMail)
	{
		final Map<String, String> map = new HashMap<>();
		map.put("API_Method", JavaHelpers.getCurrentMethodName().toString());
		final String apiRequest = "{" + Constants.QUOTE_DOUBLE + "ETID" + Constants.QUOTE_DOUBLE + ":" + Constants.QUOTE_DOUBLE + eMail
				+ Constants.QUOTE_DOUBLE + ",},";
		final String requestURL = baseAPISSO + "/Auth/" + ssoUserTokenId + "/SecurityQuestions/";
		final String json = WebService.getAPIJSONResponse("DELETE", requestURL, apiRequest, ssoUserTokenId);
		map.put("JSON", json);
		if (!json.contains(OracleConstants.API_JSON_SUCCESS))
		{
			System.out.println(json);
	...
	public Map<String, String> forgotPassword(String eMail)
	{
		...
		try
		{
			...
			final BufferedReader oBufferedReader = new BufferedReader(
	...
	public Map<String, String> lock(String etid, int lockType)
	{
		...
		final String apiRequest = "{" + Constants.QUOTE_DOUBLE + "ETID" + Constants.QUOTE_DOUBLE + ":" + Constants.QUOTE_DOUBLE + etid
				+ Constants.QUOTE_DOUBLE + ", " + Constants.QUOTE_DOUBLE + "LockType" + Constants.QUOTE_DOUBLE + ":" + lockType + "},";
	 ...
	 * 
	 * @param confirmUser
	 *            Set to "true" to confirm the user.
	...
	/**
	 * Registers a uniquely generated new user with options to confirm the user
	 * and add security questions.
	 * 
	 * @param confirmUser
	 ...
	 * 
	 * @param confirmUser
	 *            Set to true to confirm user.
	 * @param addSecurityQuestions
	 *            Set to true to add security questions
	 * @param addNames
	 *            Set to true to add names to user.
	 * @return New user's email address.
	 */
	 ...
	 * @return
	 */
	public String registerUser(String name, boolean confirmUser, boolean addSecurityQuestions, boolean addNames,
			boolean addAlternateEMail)
	{
		final Map<String, String> map = new HashMap<>();
		map.put("API_Method", JavaHelpers.getCurrentMethodName().toString());
		...
		System.out.println("Registering:[" + eMail + "] (confirmUser:[" + confirmUser + "], addSecurityQuestions:["
				+ addSecurityQuestions + "], addNames:[" + addNames + "], addAlternateEMail:[" + addAlternateEMail
				+ "]");
		final String requestURL = baseAPISSO + "/User/";
		String apiRequest = "{Password: " + Constants.QUOTE_DOUBLE + CJSConstants.PASSWORD + Constants.QUOTE_DOUBLE
				+ ",PrimaryEmail: " + Constants.QUOTE_DOUBLE + eMail + Constants.QUOTE_DOUBLE + "}";
		if (addSecurityQuestions)
		{
			final String toAdd = "," + Constants.QUOTE_DOUBLE + "QuestionsAnswers" + Constants.QUOTE_DOUBLE + ":[{" + Constants.QUOTE_DOUBLE
					+ "SecurityAnswer" + Constants.QUOTE_DOUBLE + ":" + Constants.QUOTE_DOUBLE + "abcde" + Constants.QUOTE_DOUBLE + ","
					+ Constants.QUOTE_DOUBLE + "SecurityQuestionId" + Constants.QUOTE_DOUBLE + ":2},{" + Constants.QUOTE_DOUBLE
					+ "SecurityAnswer" + Constants.QUOTE_DOUBLE + ":" + Constants.QUOTE_DOUBLE + "abcde" + Constants.QUOTE_DOUBLE + ","
					+ Constants.QUOTE_DOUBLE + "SecurityQuestionId" + Constants.QUOTE_DOUBLE + ":7},{" + Constants.QUOTE_DOUBLE
					+ "SecurityAnswer" + Constants.QUOTE_DOUBLE + ":" + Constants.QUOTE_DOUBLE + "abcde" + Constants.QUOTE_DOUBLE + ","
					+ Constants.QUOTE_DOUBLE + "SecurityQuestionId" + Constants.QUOTE_DOUBLE + ":11}]}";
			apiRequest = apiRequest.replace(apiRequest.substring(apiRequest.length() - 1), toAdd);
		}
		if (addNames)
		{
			final String toAdd = ", " + Constants.QUOTE_DOUBLE + "FirstName" + Constants.QUOTE_DOUBLE + ": " + Constants.QUOTE_DOUBLE
					+ OracleDynamicVariables.getFirstName(name) + Constants.QUOTE_DOUBLE + "," + Constants.QUOTE_DOUBLE + "LastName"
					+ Constants.QUOTE_DOUBLE + ": " + Constants.QUOTE_DOUBLE + OracleDynamicVariables.getLastName(name)
					+ Constants.QUOTE_DOUBLE + "}";
			apiRequest = apiRequest.replace(apiRequest.substring(apiRequest.length() - 1), toAdd);
		}
		if (addAlternateEMail)
		{
			final String toAdd = ", " + Constants.QUOTE_DOUBLE + "AlternateEmail" + Constants.QUOTE_DOUBLE + ": " + Constants.QUOTE_DOUBLE
					+ "Alt_" + eMail + Constants.QUOTE_DOUBLE + "}";
			apiRequest = apiRequest.replace(apiRequest.substring(apiRequest.length() - 1), toAdd);
		}
		final String ssoUserTokenId = "";
		final String json = WebService.getAPIJSONResponse("POST", requestURL, apiRequest, ssoUserTokenId);
