...
public class Email
{
	...
	private static Map<String, String> eMailSetParameters(String from, String password, String emailTO, String emailCC,
			String emailBCC, String subject, String body, String attachment) throws Exception
	{
	...
	private static void eMailSetRecipients(MimeMessage message, Map<String, String> parameters) throws Exception
	{
	...
	public static boolean sendEmail(String from, String password, String emailTO, String emailCC, String emailBCC,
			String subject, String body, List<String> attachments) throws QAException
	{
		String attachment = "";
	...
	public static boolean sendEmail(String from, String password, String emailTO, String emailCC, String emailBCC,
			String subject, String body, String attachment) throws QAException
	{
		...
		do
		{
			...
			try
			{
				...
				parameters = eMailSetParameters(from, password, emailTO, emailCC, emailBCC, subject, body, attachment);
				...
				messageBodyPart.setText(parameters.get(LABEL_BODY), StandardCharsets.UTF_8.toString(), "html");
				...
				{ // Part two is attachment
					...
					{
						final List<String> attachments = Arrays.asList(attachment.split(Constants.DELIMETER_LIST));
			...
			{
				Environment
						.sysOut(QAException.ERROR + JavaHelpers.getCurrentClassMethodName() + ":Error Sending Email.");
		...
		Environment.sysOut("Successfully sent email From [" + from + "], To:[" + emailTO + "] CC:[" + emailCC
				+ "], BC:[" + emailBCC + "], Subject:[" + subject + "]");
		return success;
	}
}