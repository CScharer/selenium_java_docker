...
public class CJSConstants
{
	...
	public static final String	PATH_FILES_DATA_PROJECT		= Constants.PATH_PROJECT + "Data"
			+ Constants.DELIMETER_PATH;
	public static final String	PATH_FILES_TOOLS			= Constants.PATH_PROJECT + "Tools"
			+ Constants.DELIMETER_PATH;
	public static final String	PATH_FILES_SQL				= PATH_FILES_DATA_PROJECT + "SQL"
			+ Constants.DELIMETER_PATH;
	public static final String	PATH_FILES_TEMPLATES		= PATH_FILES_DATA_PROJECT + "Templates"
			+ Constants.DELIMETER_PATH;
