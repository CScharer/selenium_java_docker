...
public class Reporting
{
	...
	public static synchronized void updateReportExcel(String fileName, String value, List<Map<String, String>> results)
	...
	private static void writeReportExcel(String fileName, String report, List<Map<String, String>> results)
			throws Exception, QAException
	{
