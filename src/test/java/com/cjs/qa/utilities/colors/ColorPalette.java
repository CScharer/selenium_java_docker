...
public class ColorPalette
{
	...
	public String toCode(List<ColorPalette> colorPaletteList, String type)
	{
		...
		stringBuilder.append(Constants.NEWLINE);
		for (int colorPaletteIndex = 0; colorPaletteIndex < colorPaletteList.size(); colorPaletteIndex++)
		{
			...
			if (!names.contains(name))
			{
				...
				{
					case "HEX":
						stringBuilder.append(Constants.QUOTE_DOUBLE + colorPalette.getHex() + Constants.QUOTE_DOUBLE + "");
						break;
					case "RGB":
						stringBuilder.append(Constants.QUOTE_DOUBLE + colorPalette.getRgb() + Constants.QUOTE_DOUBLE + "");
						break;
				}
				stringBuilder.append(")");
