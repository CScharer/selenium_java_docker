...
public class HTML
{
	...
	public static final String	STYLESHEET			= "<xsl:stylesheet version=" + Constants.QUOTE_DOUBLE + "1.0"
	...
	public String createStandardTable(List<String> fieldList, List<Map<String, String>> listMapReport)
	{
		return createStandardTable(fieldList, listMapReport, 0);
	}

	public String createStandardTable(List<String> fieldList, List<String> fieldNumericList, List<String> fieldCurrencyList,
	...
	public String createStandardTable(List<String> fieldList, List<Map<String, String>> reportListMap, int tab)
	{
		StringBuilder stringBuilderReport = new StringBuilder();
		stringBuilderReport.append("<html>");
		stringBuilderReport.append("<head>");
		stringBuilderReport.append("<link rel=" + Constants.QUOTE_DOUBLE + "stylesheet" + Constants.QUOTE_DOUBLE
				+ " type=" + Constants.QUOTE_DOUBLE + "text/css" + Constants.QUOTE_DOUBLE + " href="
				+ Constants.QUOTE_DOUBLE + "StandardTable.css" + Constants.QUOTE_DOUBLE + "></link>");
		stringBuilderReport.append("</head>");
		...
		for (Map<String, String> mapReport : reportListMap)
		{
			...
			{
				firstRecord = true;
				stringBuilderTable.append("<table  class=" + Constants.QUOTE_DOUBLE + "scroll" + Constants.QUOTE_DOUBLE
						+ " style=" + Constants.QUOTE_DOUBLE
						+ "border: 1px solid black; border-collapse: collapse;width: 100%;" + Constants.QUOTE_DOUBLE
						+ ">");
				stringBuilderTable.append("<thead>");
				stringBuilderTable.append("<tr>");
				for (final String field : fieldList)
				{
					stringBuilderTable.append("<th style=" + Constants.QUOTE_DOUBLE
							+ "border: 1px solid black; border-collapse: collapse; background-color: "
							+ this.headingColor + ";" + Constants.QUOTE_DOUBLE + ">");
			...
			for (final String field : fieldList)
			{
				...
				stringBuilderTable.append("<td style=" + Constants.QUOTE_DOUBLE
	...
	public String createStandardTable(List<String> fieldList, List<String> fieldNumericList, List<String> fieldCurrencyList,
			List<Map<String, String>> reportListMap, int tab)
	{
		StringBuilder stringBuilderReport = new StringBuilder();
		stringBuilderReport.append("<html>");
		stringBuilderReport.append("<head>");
		...
		for (Map<String, String> mapReport : reportListMap)
		{
			...
			for (final String field : fieldList)
			{
				...
				if (mapReport.get("Contractor").equals("Cumulative"))
				{
					stringBuilderTable.append("<td style=" + Constants.QUOTE_DOUBLE
							+ "border: 1px solid black; border-collapse: collapse; background-color: "
							+ ColorsHEX.VIVIT_BLUE.getValue() + ";" + Constants.QUOTE_DOUBLE + ">");
				}
				...
				if (!mapReport.get("Contractor").equals("Cumulative") && !mapReport.get("Contractor").equals("Annual"))
				{
					stringBuilderTable.append("<td style=" + Constants.QUOTE_DOUBLE
							+ "border: 1px solid black; border-collapse: collapse;" + Constants.QUOTE_DOUBLE + ">");
				}
				...
				{
					stringBuilderTable
							.append("<font color=" + Constants.QUOTE_DOUBLE + "red" + Constants.QUOTE_DOUBLE + ">");
					fontBold = true;
					fontUnderline = true;
				}
				if (fontBold)
	...
	public String createStandardTableLogo(String logoHREF, String logoSource, int tab)
	{
		...
		stringBuilderReport.append("<link rel=" + Constants.QUOTE_DOUBLE + "stylesheet" + Constants.QUOTE_DOUBLE
				+ " type=" + Constants.QUOTE_DOUBLE + "text/css" + Constants.QUOTE_DOUBLE + " href="
				+ Constants.QUOTE_DOUBLE + "TableReport.css" + Constants.QUOTE_DOUBLE + "></link>");
		stringBuilderReport.append("</head>");
		stringBuilderReport.append("<body>");
		StringBuilder stringBuilderTable = new StringBuilder();
		StringBuilder stringBuilderHeader = new StringBuilder();
		stringBuilderHeader.append("<table class=" + Constants.QUOTE_DOUBLE + "scroll" + Constants.QUOTE_DOUBLE
				+ " style=" + Constants.QUOTE_DOUBLE + "border: 1px solid black; border-collapse: collapse;width: 100%;"
				+ Constants.QUOTE_DOUBLE + ">");
		stringBuilderHeader.append("<tr>");
		stringBuilderHeader.append("<th style=" + Constants.QUOTE_DOUBLE
				+ "border: 1px solid black; border-collapse: collapse; background-color: " + this.headerFooterColor
				+ ";" + Constants.QUOTE_DOUBLE + ">");
		stringBuilderHeader
				.append("<div style=" + Constants.QUOTE_DOUBLE + "height: 100px" + Constants.QUOTE_DOUBLE + ">");
		stringBuilderHeader.append("<img href=" + Constants.QUOTE_DOUBLE + logoHREF + Constants.QUOTE_DOUBLE + " src="
				+ Constants.QUOTE_DOUBLE + logoSource + Constants.QUOTE_DOUBLE + " alt=" + Constants.QUOTE_DOUBLE
				+ "Error" + Constants.QUOTE_DOUBLE + " style=" + Constants.QUOTE_DOUBLE
