...
public class Constants
{
	...
	// System.getenv("USERNAME").toUpperCase()
	public static final String			CURRENT_USER				= System.getProperty("user.name").toUpperCase();
	...
	public static final String			PATH_SQLITE3_FILE			= PATH_APPDATA_LOCAL + "Android" + FS + "sdk" + FS
			+ "platform-tools" + FS + "sqlite3.exe";
	public static final String			PATH_OUTLOOK_SIGNATURES		= PATH_APPDATA_ROAMING + "Microsoft" + FS
			+ "Signatures" + FS;
	...
	public static final String			PATH_DRIVERS_LOCAL			= "C:" + Constants.FS + "Selenium" + Constants.FS
			+ "Grid2" + Constants.FS + "Drivers" + Constants.FS;
	public static final String			PATH_DRIVERS_REPOSITORY		= PATH_ROOT + "src" + FS + "test" + FS + "resources"
			+ FS + "Drivers" + FS;
	...
	public static final String			CJS							= SYMBOL_REGISTERED + SYMBOL_COPYRIGHT + "cjs"
			+ SYMBOL_TRADEMARK;
	public static final String			CLASS_METHOD_DEBUG			= "***ClassMethodDebug***:[";
	// All 50 U.S States
	protected static final List<String>	US_ALLSTATES				= Arrays.asList("Alaska", "Alabama", "Arkansas",
			"Arizona", "California", "Colorado", "Connecticut", "Delaware", "Florida", "Georgia", "Hawaii", "Iowa",
			...
			"Vermont", "Washington", "Wisconsin", "West Virginia", "Wyoming", "District of Columbia");
