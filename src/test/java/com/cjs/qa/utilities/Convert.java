...
public class Convert
{
	...
	public static List<List<String>> fromDataTableToList(DataTable dataTable, boolean includeEmptyValues)
	{
	...
	public static Map<String, String> fromDataTableToMap(DataTable dataTable, boolean includeEmptyValues)
	{
	...
	public static DataTable fromListToDataTable(List<List<String>> listList, boolean includeEmptyValues)
	{
	...
	public static Map<String, String> fromListToMap(List<List<String>> listList, boolean includeEmptyValues)
	{
	...
	public static List<List<String>> fromMapToList(Map<String, String> map, boolean includeEmptyValues)
	{
	...
	private static Map<String, String> fromNumberToLetterExcelLevel(Map<String, String> mapInstances, int maxNumber)
	{
