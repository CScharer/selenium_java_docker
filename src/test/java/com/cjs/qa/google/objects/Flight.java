...
public class Flight
{
	...
	public Flight(String airport, String preference, int sort, String airline, String operatedBy, String timeDepart,
			String duration, String timeArrive, String stops, double price)
	{
