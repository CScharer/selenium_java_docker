...
{
	public Map<String, String> cancelWebinar(String credentials, String organizerKey, String webinarKey)
			throws Throwable
	{
	...
	public Map<String, String> createWebinar(String credentials, String organizerKey) throws Throwable
	{
	...
	public Map<String, String> getAllInsessionWebinars(String credentials, String organizerKey) throws Throwable
	{
	...
	public Map<String, String> getAllWebinarsForAnAccount(String credentials, String accountKey) throws Throwable
	{
		...
		curlStringBuilder.append("&fromTime=\"" + DateHelpers.getCurrentDateTime(formatDateLeft) + "T"
				+ DateHelpers.getCurrentDateTime(formatDateRight) + "Z\"");
		curlStringBuilder.append("&toTime=\"" + DateHelpers.getCurrentDatePlusMinusDays(formatDateLeft, 365) + "T"
				+ DateHelpers.getCurrentDatePlusMinusDays(formatDateRight, 365) + "Z\"");
	...
	public Map<String, String> getAttendeesForAllWebinarSessions(String credentials, String organizerKey,
			String webinarKey) throws Throwable
	{
		// /organizers/{organizerKey}/webinars/{webinarKey}/attendees
		String url = API_GT_BASE + "/organizers/" + organizerKey + "/webinars/" + webinarKey + "/attendees";
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("");
		return getAPIJSONResponse(credentials, "GET", stringBuilder.toString(), url);
	}

	public Map<String, String> getAudioInformation(String credentials, String organizerKey, String webinarKey)
			throws Throwable
	{
	...
	public Map<String, String> getPerformanceForAllWebinarSessions(String credentials, String organizerKey,
			String webinarKey) throws Throwable
	{
		// /organizers/{organizerKey}/webinars/{webinarKey}/performance
		String url = API_GT_BASE + "/organizers/" + organizerKey + "/webinars/" + webinarKey + "/performance";
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("");
		return getAPIJSONResponse(credentials, "GET", stringBuilder.toString(), url);
	}

	public Map<String, String> getWebinar(String credentials, String organizerKey, String webinarKey) throws Throwable
	{
		// /organizers/{organizerKey}/webinars/{webinarKey}
		String url = API_GT_BASE + "/organizers/" + organizerKey + "/webinars/" + webinarKey;
		StringBuilder stringBuilder = new StringBuilder();
	...
	public Map<String, String> getWebinarMeetingTimes(String credentials, String organizerKey, String webinarKey)
			throws Throwable
	{
		// /organizers/{organizerKey}/webinars/{webinarKey}/meetingtimes
		String url = API_GT_BASE + "/organizers/" + organizerKey + "/webinars/" + webinarKey + "/meetingtimes";
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("");
		return getAPIJSONResponse(credentials, "GET", stringBuilder.toString(), url);
	}
	...
	public Map<String, String> updateAudioInformation(String credentials, String organizerKey, String webinarKey)
			throws Throwable
	{
		// /organizers/{organizerKey}/webinars/{webinarKey}/audio
		String url = API_GT_BASE + "/organizers/" + organizerKey + "/webinars/" + webinarKey + "/audio";
	...
	public Map<String, String> updateWebinar(String credentials, String organizerKey, String webinarKey)
			throws Throwable
	{
		// /organizers/{organizerKey}/webinars/{webinarKey}
		String url = API_GT_BASE + "/organizers/" + organizerKey + "/webinars/" + webinarKey;
