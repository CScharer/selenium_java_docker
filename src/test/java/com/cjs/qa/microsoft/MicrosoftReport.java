...
public class MicrosoftReport
{
	...
	private static String getReportHeader(String section, List<String> fieldList)
	{
		...
		stringBuilder.append("<table class=" + Constants.QUOTE_DOUBLE + "scroll" + Constants.QUOTE_DOUBLE + " style="
				+ Constants.QUOTE_DOUBLE + "border: 1px solid black; border-collapse: collapse;width: 100%;"
	...
	{
		final StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(getReportHeader("Points (Breakdown)", PointsBreakdown.getReportFieldList()));
	...
	{
		final StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append(getReportHeader("Dashboard (Reward Info)", RewardsInfo.getReportFieldList()));
		stringBuilder.append(RewardsInfo.toReport());
		stringBuilder.append(getReportFooter());
		return stringBuilder.toString();
	}
