...
public class XLSXCellStyles
{
	...
	public static final int				CELL_STYLE_INDEX_DEFINED	= (CELL_STYLE_INDEX_START
			+ IExcel.CELL_STYLE_DEFINED_COUNT);
	public static List<XLSXCellStyles>	stylesList					= new ArrayList<>();
	...
	public XLSXCellStyles(int styleIndex, String styleName, CellStyle styleObject) throws QAException
	{
	...
	{
		final String cellStyleName = JavaHelpers.getCurrentMethodName().replace(IExcel.PREFIX_CREATE_CELL_STYLE, "");
	...
	public static void setCellStyles(XSSFWorkbook workbook) throws QAException
	{
		switch (workbook.getNumCellStyles())
		{
			...
			case CELL_STYLE_INDEX_DEFINED:
				...
				for (int cellStyleIndex = 0; cellStyleIndex < (IExcel.CELL_STYLE_LIST.size() - 1); cellStyleIndex++)
				{
					...
					final CellStyle cellStyle = workbook.getCellStyleAt(CELL_STYLE_INDEX_START + cellStyleIndex);
	...
	public static CellStyle getCellStyle(XSSFWorkbook xssfWorkbook, String styleName) throws QAException
	{
