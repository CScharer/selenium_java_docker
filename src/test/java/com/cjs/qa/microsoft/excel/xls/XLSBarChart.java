...
public class XLSBarChart extends XLS
{
	...
	public void create(int rowStart, int rowEnd) throws QAException
	{
		try
		{
			...
			final JFreeChart jFreeChart = ChartFactory.createBarChart(title, title, "Count", defaultCategoryDataset,
			...
			final int picture = getWorkbook().addPicture(byteArrayOutputStream.toByteArray(),
