...
public class XLS implements IExcel
{
			...
			throws QAException
	{
		...
		getWorkCell().setCellStyle(XLSCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HYPERLINK));
		//
	...
	private void setCellValue(Object value) throws QAException
	{
		...
		if (value instanceof Double)
		{
			...
			getWorkCell().setCellStyle(XLSCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_NUMBER));
		}
			...
			try
			{
				if (containsPercentSign || isNumeric)
				{
					...
					if (containsPercentSign)
					{
						...
						getWorkCell()
								.setCellStyle(XLSCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_PERCENT));
					} else
					{
	...
	public boolean setFormatFontBackgroundColor(int sheet, int column, int row, String color) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HEADING));
		return true;
	}
	...
	public boolean setFormatFontColor(int sheet, int column, int row, String color) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		setWorkCellStyle((HSSFCellStyle) XLSCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HYPERLINK));
	...
	public void setFormatNormal(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_NORMAL));
	}
	...
	public void setFormatSection(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_SECTION));
	}
	...
	public void setFormatStatus(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_STATUS));
	}
