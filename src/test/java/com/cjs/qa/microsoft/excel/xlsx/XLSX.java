...
public class XLSX implements IExcel {
  ...
  public boolean addLink(
    ...
    getWorkCell()
        .setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HYPERLINK));
    //
  ...
  public boolean setFormatFontBackgroundColor(int sheet, int column, int row, String color)
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell()
        .setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HEADING));
    return true;
  }
  ...
  public boolean setFormatFontColor(int sheet, int column, int row, String color)
    ...
    setWorkCell(getWorkRow().getCell(column));
    setWorkCellStyle(
        (XSSFCellStyle) XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HYPERLINK));
  ...
  public void setFormatNormal(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell()
        .setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_NORMAL));
  }
  ...
  public void setFormatSection(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell()
        .setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_SECTION));
  }
  ...
  public void setFormatStatus(int sheet, int column, int row) throws QAException {
    ...
    setWorkCell(getWorkRow().getCell(column));
    getWorkCell()
        .setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_STATUS));
  }
