...
public class XLSX implements IExcel
{
	...
	public XLSX(String fileName, String sheetName) throws QAException, IOException
	{
		...
		Environment.sysOut("fileType Expected: [" + fileNameExtensionExpected + "], fileName:[" + getFileName()
				+ "], sheet:" + sheetName + "]");
		...
		{
			Assert.fail("The file [" + getFileName() + "] does not match the expected file extension of ["
	...
	public boolean addComment(int sheet, int column, int row, String sComment, boolean visible) throws QAException
	{
	...
	public boolean addComment(String sheet, int column, int row, String sComment, boolean visible) throws QAException
	{
	...
	public boolean addLink(int sheet, int column, int row, String linkType, String linkText, String linkValue)
			throws QAException
	{
		...
		getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HYPERLINK));
		//
	...
	public boolean addLink(String sheet, int column, int row, String linkType, String linkText, String linkValue)
			throws QAException
	{
		if (!sheetExists(sheet))
		{
	...
	private void setCellValue(Object value) throws QAException
	{
		...
		if (value instanceof Double)
		{
			...
			getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_NUMBER));
		}
			...
			try
			{
				if (containsPercentSign || isNumeric)
				{
					...
					if (containsPercentSign)
					{
						...
						getWorkCell()
								.setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_PERCENT));
					} else if (isNumeric)
					{
						valueFloat = (Float.valueOf(stringValue.trim()).floatValue());
						setCellValue(valueFloat);
						getWorkCell().setCellStyle(
								XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_NUMBERPERCENT));
					}
				} else
				{
	...
	public void setFormatBold(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_BOLD));
	}
	...
	public void setFormatFail(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_FAIL));
	}
	...
	public boolean setFormatFontBackgroundColor(int sheet, int column, int row, String color) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HEADING));
		return true;
	}

	public boolean setFormatFontBackgroundColor(String sheet, int column, int row, String color) throws QAException
	{
		if (!sheetExists(sheet))
		{
			return false;
	...
	public boolean setFormatFontColor(int sheet, int column, int row, String color) throws QAException
	{
		if (!columnExists(sheet, column, row))
		{
			return false;
		...
		setWorkCell(getWorkRow().getCell(column));
		setWorkCellStyle((XSSFCellStyle) XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_HYPERLINK));
	...
	public boolean setFormatFontColor(String sheet, int column, int row, String color) throws QAException
	{
		if (!sheetExists(sheet))
		{
			return false;
	...
	public void setFormatNormal(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_NORMAL));
	}
	...
	public void setFormatPass(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_PASS));
	}
	...
	public void setFormatSection(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_SECTION));
	}
	...
	public void setFormatStatus(int sheet, int column, int row) throws QAException
	{
		...
		setWorkCell(getWorkRow().getCell(column));
		getWorkCell().setCellStyle(XLSXCellStyles.getCellStyle(getWorkbook(), IExcel.FORMAT_NAME_STATUS));
	}
	...
	public String writeCellFormula(String sheetName, int column, int row, String value) throws QAException
	{
		if (value.equals(""))
		{
			return String.valueOf(value);
