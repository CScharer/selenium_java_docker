...
public class XLSBarChartExample
{
	public static void main(String[] args) throws Exception
	{
		 ...
		 */
		final HSSFWorkbook workbookXLS = new HSSFWorkbook(fileInputStream);
		...
		final JFreeChart jFreeChart = ChartFactory.createBarChart("Subject Vs Marks", "Subject", "Marks",
		 ...
		 * to Excel worksheet
		 */
		final int my_picture_id = workbookXLS.addPicture(byteArrayOutputStream.toByteArray(),
