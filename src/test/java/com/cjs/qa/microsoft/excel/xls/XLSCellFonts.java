...
{
	public static List<XLSCellFonts>	fontsList	= new ArrayList<>();
	...
	{
		final String cellFontName = JavaHelpers.getCurrentMethodName().replace(IExcel.PREFIX_CREATE_CELL_FONT, "");
