...
public class TestXLSX
{
	...
	public void testXLSX() throws IOException, QAException
	{
		...
		excel.addComment(IExcel.SHEET_SUMMARY, 0, 0,
				"This sheet contains summary information and links to the associated data sheets.", false);
			...
			for (int row = 0; row < MAX_ROWS; row++)
			{
				...
				switch (format)
				{
					...
					case IExcel.FORMAT_NAME_HEADING:
						...
						break;
					case IExcel.FORMAT_NAME_HYPERLINK:
						final String hyperlink = "'" + IExcel.SHEET_SUMMARY + "'!A" + (excel.getSheetCount() - 1);
