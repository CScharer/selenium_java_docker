...
{
	public static final List<String>		reportFieldList		= Arrays.asList("Method", "xPath", "Index", "Group",
			...
			for (final String field : getReportFieldList())
			{
				...
				switch (field)
				{
					...
					case "Points (Available)":
						value = MicrosoftReport.getFieldHTML(
								JavaHelpers.formatNumber(Double.valueOf(pointsBreakdown.getPointsAvailable()),
										MicrosoftReport.getFORMAT_NUMBER()));
						break;
					case "Points (Earned)":
						value = MicrosoftReport.getFieldHTML(JavaHelpers.formatNumber(
								Double.valueOf(pointsBreakdown.getPointsEarned()), MicrosoftReport.getFORMAT_NUMBER()));
						break;
					case "xPath":
						value = MicrosoftReport.getFieldHTML(pointsBreakdown.getxPath().replaceAll("By.xpath: ", ""));
						break;
					default:
						break;
				}
